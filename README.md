...
<div align="center">
  <img src="documentations/training_metrics_comparison.png" alt="Training-related Metrics Comparison" style="width: 100%; max-width: 700px;">
  <img src="documentations/inference_metrics_comparison.png" alt="Inference-related Metrics Comparison" style="width: 100%; max-width: 700px;">
</div>
...
- **Model Preparation Time (ms):**  
  pi0-FAST takes longer to load and prepare the model (32.84±4.22 ms) compared to pi0 (24.55±3.58 ms), possibly due to the additional components required for token decoding.
- **Inference Time (ms):**  
  pi0-FAST has a higher average inference time per step (3.80±0.59 ms) than pi0 (2.36±0.47 ms), reflecting the extra computation for autoregressive token generation.
